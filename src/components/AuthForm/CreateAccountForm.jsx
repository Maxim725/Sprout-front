...
export const CreateAccountForm = ({ switchLoginOrCreate, register }) => {
	...
	return (
		<div className="auth__create-container">
			<h1 className="auth__create-header auth__padding-top auth__padding-side">Create account</h1>
			<form className="auth__create-form" onSubmit={(e) => { e.preventDefault(); register(firstName, lastName, email, phone, birthDate, password) }}>
				<div className="auth__padding-side auth__create-form-normalize">
					<div className="auth__create-item-container">
						<label className="auth__create-item">
							<p className="auth__create-text">First name</p>
							<input className="auth__create-input" type="text" onChange={(e) => setFirstName(e.target.value)} />
						</label>
						<label className="auth__create-item">
							<p className="auth__create-text">Phone</p>
							<input className="auth__create-input" type="text" onChange={(e) => setPhone(e.target.value)} />
						</label>
						<label className="auth__create-item">
							<p className="auth__create-text">Birth date</p>
							<input className="auth__create-input" type="text" onChange={(e) => setBirthDate(e.target.value)} />
						</label>
					</div>
					<div className="auth__create-item-container">
						<label className="auth__create-item">
							<p className="auth__create-text">Last name</p>
							<input className="auth__create-input" type="text" onChange={(e) => setLastName(e.target.value)} />
						</label>
						<label className="auth__create-item">
				...
				<div class="auth__subform auth__padding-side">
					...
					<div className="auth__subform-link-container">
						<p className="auth__subform-link-text">Have an account yet?</p>
						<a className="auth__subform-link" onClick={switchLoginOrCreate}>Log in</a>
					</div>
				</div>
			</form>
		</div>
